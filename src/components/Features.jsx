    ...
    <div>
      <div className="relative mt-20 border-b border-neutral-800 min-h-[800px]">
        <div className="text-center">
          <span className="bg-neutral-900 text-purple-400 rounded-full text-2xl h-6 font-medium px-2 py-1 uppercase">
            Features
          </span>
        ...
        <div className="flex flex-wrap mt-10 lg:mt-20">
          {features.map((feature, index) => (
            <div className="w-full sm:1/2 lg:w-1/3" key={index}>
              <div className="flex">
                {/* <div className="flex mx-6 h-10 w-10 bg-neutral-900 text-purple-800 justify-center items-center rounded-full">
                  {feature.icon}
                </div> */}
                <div>
